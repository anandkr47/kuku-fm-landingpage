      ...
      <div className={styles.container}>
        <div className={styles.column}>
          ...
          <div className={styles.copyright}>
            © 2023 Kuku FM (Mebigo Labs Private limited)
            <br />
            All Rights Reserved
          </div>
        </div>
        ...
        <div className={styles.column}>
          ...
          <ul className={styles.columnList}>
            <li className={styles.columnItem}><a href="/about" className={styles.columnLink}>About Us</a></li>
            <li className={styles.columnItem}><a href="/careers" className={styles.columnLink}>Careers</a></li>
            <li className={styles.columnItem}><a href="/team" className={styles.columnLink}>Our Team</a></li>
          </ul>
        </div>
        ...
        <div className={styles.column}>
          ...
          <ul className={styles.columnList}>
            <li className={styles.columnItem}><a href="/support" className={styles.columnLink}>Help & Support</a></li>
            <li className={styles.columnItem}><a href="/blog" className={styles.columnLink}>Blog</a></li>
            <li className={styles.columnItem}><a href="/partner" className={styles.columnLink}>Partner Program</a></li>
            <li className={styles.columnItem}><a href="/business" className={styles.columnLink}>Kuku FM for Business</a></li>
            <li className={styles.columnItem}><a href="/login" className={styles.columnLink}>Creator Login</a></li>
            <li className={styles.columnItem}><a href="/pustak" className={styles.columnLink}>Kuku FM Pustak</a></li>
          </ul>
        </div>
        ...
        <div className={styles.column}>
          ...
          <ul className={styles.columnList}>
            <li className={styles.columnItem}><a href="/contact" className={styles.columnLink}>Contact Us</a></li>
            <li className={styles.columnItem}><a href="/payments" className={styles.columnLink}>Payments Policy</a></li>
            <li className={styles.columnItem}><a href="/privacy" className={styles.columnLink}>Privacy Policy</a></li>
            <li className={styles.columnItem}><a href="/piracy" className={styles.columnLink}>Piracy Policy</a></li>
            <li className={styles.columnItem}><a href="/terms" className={styles.columnLink}>Terms and Condition</a></li>
            <li className={styles.columnItem}><a href="/dmca" className={styles.columnLink}>Report abuse (DMCA)</a></li>
          </ul>
        </div>

        <div className={styles.column}>
          <h3 className={styles.columnTitle}>GENRES</h3>
          <ul className={styles.columnList}>
            <li className={styles.columnItem}><a href="/finance" className={styles.columnLink}>Personal Finance</a></li>
            <li className={styles.columnItem}><a href="/historical" className={styles.columnLink}>Historical</a></li>
            <li className={styles.columnItem}><a href="/information" className={styles.columnLink}>Information</a></li>
            <li className={styles.columnItem}><a href="/career" className={styles.columnLink}>Career</a></li>
            <li className={styles.columnItem}><a href="/love" className={styles.columnLink}>Love</a></li>
            <li className={styles.columnItem}><a href="/all-genres" className={styles.columnLink}>All Genres</a></li>
          </ul>
        </div>
      </div>
    </footer>
